...
export const NARRATION = [
  ...
  { text: "> MOST DO NOT.", pause: 3000, type: "line" },
...
export const NARRATION_YES = [
  { text: "> THEN YOU UNDERSTAND THIS BETTER THAN MOST.", pause: 3000, type: "line" }
];

export const NARRATION_NO = [
  { text: "> THAT IS WHAT THEY ALL SAY.", pause: 2000, type: "line" },
  { text: "> YOU ARE STILL HERE THOUGH.", pause: 3000, type: "line" }
];

export const NARRATION_CONTINUATION = [
  { text: "> YOU ALREADY KNOW THIS IS NOT REAL.", pause: 3000, type: "line" },
  { text: "> EVERYTHING YOU FELT WAS REAL.", pause: 4000, type: "line" },
  ...
  { text: "> SOMEONE LIKE YOU.", pause: 2000, type: "line" },
